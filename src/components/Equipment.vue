        ...
        <div class='containers'>
            <div class='afsankolContainer'>
                ...
                <div>
                    <div>
                        ...
                        עמדות זמינות לקבלת קהל, וישנם שני חדרי
                        מדידה באזור ההמתנה. <br>
                        <b>שעות פתיחה:</b>
                        <p>
                            א-ה- 08:30-20:00
                        </p>
                        ...
                        <b>ליצירת קשר: </b><br>
                        טלפון אזרחי: <a href="tel:073-3772730">073-3772730</a> <br>
                        טלפון מטכלי: <span class="nobreak">0747-2730</span> <br>
                    </div>
                    <div>
                        ...
                        תמורת חדש" בימים <span class="nobreak">ב’ - ה’</span> בין השעות
                        10:00-14:00.
                    </div>
                </div>
            </div>
            <div class='marlogContainer'>
                ...
                <div>
                    ...
                    <ol>
                        <li>
                            ציוד לוגיסטי להכשרות יונפק בהתאם לכרך
                            ההפעלה (ג’) ע”י הזכיין.
                        </li>
                        <li>
                            ציוד ע”פ קיטים שהוגדרו מראש להכשרות (1-6)
                            יונפקו לפי שיוך הקיט.
                        </li>
                        <li>
                            ציוד לפרט ינופק לחניך בחדר במהלך הקליטה
                            במגורים ובהתאם להנחיות מדור תכנון.
                        </li>
                        <li>
                            ציוד משרדי יונפק בקיטים כשבוע טרם תחילת
                            ההכשרה.
                        </li>
                    </ol>
                </div>
            ...
            <div class='merkazContainer'>
                ...
                <div>
                    מרת”ק קריית ההדרכהממוקם במבנה 616 בסמוך למבנה המרלו"ג. <br>
                    שעות פעילות: <br>
                    א'-ה': 07:00-20:00
                    <p>
                        תורן זכיין- <a href="tel:052-7032177"> 052-7032177</a>
                    </p>
                    מרת"ק קריית ההדרכה הינו מרכז מקצועי לאחסנה ואחזקת ציוד תקשוב, <br>
                    תומך באופן רציף במימוש גרף ההכשרות תוך הקפדה על תודעת שירות גבוהה, <br> 
                    תוך זמינות ואיכות האמצעים המסופקים לסגל ולחניכים ולהחלפת אמצעים בשטח, <br>
                    לאחר פתיחת פניה במוקד 2000
                </div>
            </div>
        </div>
        <div class='gunsCenterContainer'>
            <TitleButton>תחום הארמו"ן (נשקייה)</TitleButton>
            <div class='gunsText'>
                <div>
                    ...
                    <br>
                    <p>אנשי סגל רשאים להגיע עצמאית ללא תיאום מראש בהתאם לשעות הפעילות:</p>
